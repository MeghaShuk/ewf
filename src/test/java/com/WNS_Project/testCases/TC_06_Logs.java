...
public class TC_06_Logs extends BaseClass {
	...
	@Description("This TestCase will verify that the logs of the Worker Node Server are visible and provide real-time updates. If the logs are not accessible or there is an authorization issue, an alert should be triggered to notify the team for immediate investigation.")
